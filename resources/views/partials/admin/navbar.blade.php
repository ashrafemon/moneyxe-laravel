    ...
    <div class="container-fluid">
        ...
        <ul class="navbar-nav align-items-center d-none d-xl-block">
            <li class="nav-item dropdown">
                <a aria-expanded="false" aria-haspopup="true" class="nav-link pr-md-0 d-none d-lg-block"
        ...
        <a class="navbar-brand pt-0 d-md-none" href="index.html">
            <img src="{{asset('assets/admin/img/brand/logo-light.png')}}" class="navbar-brand-img" alt="...">
        </a>
        <!-- Form -->
        ...
        <ul class="navbar-nav align-items-center ">
            <li class="nav-item d-none d-md-flex">
                <div class="dropdown d-none d-md-flex mt-2 ">
                    <a class="nav-link full-screen-link pl-0 pr-0"><i class="fe fe-maximize-2 floating "
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-arrow dropdown-menu-right">
                    <a class="dropdown-item d-flex" href="#">
                        <span class="avatar brround mr-3 align-self-center"> <img
                                src="{{asset('assets/admin/img/faces/male/4.jpg')}}" alt="imag"></span>
                        <div>
                    ...
                    <a class="dropdown-item d-flex" href="#">
                        <span class="avatar brround mr-3 align-self-center"><img
                                src="{{asset('assets/admin/img/faces/female/14.jpg')}}" alt="imag"></span>
                        <div>
                    ...
                    <a class="dropdown-item d-flex" href="#">
                        <span class="avatar brround mr-3 align-self-center"><img
                                src="{{asset('assets/admin/img/faces/male/1.jpg')}}" alt="imag"></span>
                        <div>
                    ...
                    <div class="dropdown-divider"></div><a class="dropdown-item text-center text-muted-dark"
                        href="#">View all Requestes</a>
                </div>
            </li>
            ...
            <li class="nav-item dropdown d-none d-md-flex">
                ...
                <div class="dropdown-menu  dropdown-menu-lg dropdown-menu-arrow dropdown-menu-right">
                    ...
                    <a href="#" class="dropdown-item d-flex">
                        <span class="avatar brround mr-3 align-self-center"><img
                                src="{{asset('assets/admin/img/faces/male/41.jpg')}}" alt="img"></span>
                        <div>
                    ...
                    <a href="#" class="dropdown-item d-flex">
                        <span class="avatar brround mr-3 align-self-center"><img
                                src="{{asset('assets/admin/img/faces/female/1.jpg')}}" alt="img"></span>
                        <div>
            ...
            <li class="nav-item dropdown">
                <a aria-expanded="false" aria-haspopup="true" class="nav-link pr-md-0" data-toggle="dropdown" href="#"
                    role="button">
                    <div class="media align-items-center">
                        <span class="avatar avatar-sm rounded-circle"><img alt="Image placeholder"
                                src="{{asset('assets/admin/img/faces/female/32.jpg')}}"></span>
                ...
                <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
                    ...
                    <a class="dropdown-item" href="user-profile.html"><i class="ni ni-single-02"></i> <span>My
                            profile</span></a>
