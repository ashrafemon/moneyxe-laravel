        ...
        ============================================= -->
          ...
          =============================== -->
                        ...
                        <div class="transaction-item px-4 py-3" data-toggle="modal" data-target="#transaction-detail">
                            <div class="row align-items-center flex-row">
                                ...
                                <div class="col col-sm-7"> 
                                    ...
                                    <span
                                        class="text-muted text-capitalize">Received to {{$exchange->received_method}}</span> 
                                </div>
            ...
            =========================================== -->
                    ...
                    <!-- View all Link
            =============================== -->
                    <div class="text-center mt-4"><a href="{{route('client.transactions.index')}}" class="btn-link text-3">View all<i
