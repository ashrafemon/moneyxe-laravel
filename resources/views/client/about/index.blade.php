    ...
    <section class="page-header page-header-text-light py-0 mb-0">
        <section class="hero-wrap section">
            ...
            <div class="hero-bg hero-bg-scroll"
                style="background-image:url({{asset('assets/client/images/bg/image-2.jpg')}});"></div>
            <div class="hero-content">
                <div class="container">
                    <div class="row">
                        <div class="col-12 text-center">
                            <h1 class="text-11 font-weight-500 text-white mb-4">About Payyed</h1>
                            <p class="text-5 text-white line-height-4 mb-4">Our mission is to help you save on transfer
                                fees and exchange rates!</p>
    ...
    <section class="section">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 my-auto text-center"> <img class="img-fluid shadow-lg rounded-lg"
                        src="{{asset('assets/client/images/who-we-are.jpg')}}" alt=""> </div>
            </div>
        </div>
    </section>
    <!-- Who we are end -->
        ...
        <div class="container">
            <div class="row no-gutters">
                <div class="col-lg-6 order-2 order-lg-1">
                    <div class="row">
                        <div class="col-6 col-lg-7 ml-auto mb-lg-n5"> <img class="img-fluid rounded-lg shadow-lg"
                                src="{{asset('assets/client/images/our-values-vision.jpg')}}" alt="banner"> </div>
                        <div class="col-6 col-lg-8 mt-lg-n5"> <img class="img-fluid rounded-lg shadow-lg"
                                src="{{asset('assets/client/images/our-values-mission.jpg')}}" alt="banner"> </div>
                    </div>
                </div>
                <div class="col-lg-6 d-flex order-1 order-lg-2">
                    <div class="my-auto px-0 px-lg-5">
                        ...
                        <p class="tex-3">Quidam lisque persius interesset his et, in quot quidam persequeris vim, ad mea
                            essent possim iriure. Lisque persius interesset his et, in quot quidam persequeris vim, ad
                            mea essent possim iriure. lisque persius interesset his et, in quot quidam mea essent possim
                            iriure.</p>
                        <h4 class="text-4 font-weight-500 mb-2">Our Vision</h4>
                        <p class="tex-3">Persequeris quidam lisque persius interesset his et, in quot quidam vim, ad mea
                            essent possim iriure. Lisque persius interesset his et, in quot quidam persequeris vim, ad
                            mea essent possim iriure. lisque persius interesset his et, in quot quidam.</p>
                        <h4 class="text-4 font-weight-500 mb-2">Our Goal</h4>
                        <p class="tex-3">Lisque persius interesset his et, in quot quidam persequeris vim, ad mea essent
                            possim iriure. Lisque persius interesset his et, in quot quidam persequeris vim, ad mea
                            essent possim iriure. lisque persius interesset his et, in quot quidam mea essent possim
                            iriure.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 col-md-3 text-center mb-4 mb-md-0">
                    <div class="team rounded d-inline-block"> <img class="img-fluid rounded" alt=""
                            src="{{asset('assets/client/images/team/leader.jpg')}}">
                        <h3>Neil Patel</h3>
                        <p class="text-muted">CEO &amp; Founder</p>
                        <ul class="social-icons social-icons-sm d-inline-flex">
                            <li class="social-icons-facebook"><a data-toggle="tooltip" href="#" target="_blank" title=""
                                    data-original-title="Facebook"><i class="fab fa-facebook-f"></i></a></li>
                            <li class="social-icons-twitter"><a data-toggle="tooltip" href="" target="_blank" title=""
                                    data-original-title="Twitter"><i class="fab fa-twitter"></i></a></li>
                            <li class="social-icons-google"><a data-toggle="tooltip" href="" target="_blank" title=""
                ...
                <div class="col-sm-6 col-md-3 text-center mb-4 mb-md-0">
                    <div class="team rounded d-inline-block"> <img class="img-fluid rounded" alt=""
                            src="{{asset('assets/client/images/team/leader-2.jpg')}}">
                        <h3>James Maxwell</h3>
                ...
                <div class="col-sm-6 col-md-3 text-center mb-4 mb-md-0">
                    <div class="team rounded d-inline-block"> <img class="img-fluid rounded" alt=""
                            src="{{asset('assets/client/images/team/leader-3.jpg')}}">
                        <h3>Ruby Clinton</h3>
                ...
                <div class="col-sm-6 col-md-3 text-center mb-4 mb-md-0">
                    <div class="team rounded d-inline-block"> <img class="img-fluid rounded" alt=""
                            src="{{asset('assets/client/images/team/leader-4.jpg')}}">
                        <h3>Miky Sheth</h3>
        ...
        <div class="container">
            ...
            <div class="brands-grid separator-border">
                <div class="row align-items-center">
                    <div class="col-6 col-sm-4 col-lg-2 text-center"><a href=""><img class="img-fluid"
                                src="{{asset('assets/client/images/partner/partner-1.png')}}" alt="Brands"></a></div>
                    <div class="col-6 col-sm-4 col-lg-2 text-center"><a href=""><img class="img-fluid"
                                src="{{asset('assets/client/images/partner/partner-2.png')}}" alt="Brands"></a></div>
                    <div class="col-6 col-sm-4 col-lg-2 text-center"><a href=""><img class="img-fluid"
                                src="{{asset('assets/client/images/partner/partner-3.png')}}" alt="Brands"></a></div>
                    <div class="col-6 col-sm-4 col-lg-2 text-center"><a href=""><img class="img-fluid"
                                src="{{asset('assets/client/images/partner/partner-4.png')}}" alt="Brands"></a></div>
                    <div class="col-6 col-sm-4 col-lg-2 text-center"><a href=""><img class="img-fluid"
                                src="{{asset('assets/client/images/partner/partner-5.png')}}" alt="Brands"></a></div>
                    <div class="col-6 col-sm-4 col-lg-2 text-center"><a href=""><img class="img-fluid"
                                src="{{asset('assets/client/images/partner/partner-6.png')}}" alt="Brands"></a></div>
                    <div class="col-6 col-sm-4 col-lg-2 text-center"><a href=""><img class="img-fluid"
                                src="{{asset('assets/client/images/partner/partner-7.png')}}" alt="Brands"></a></div>
                    <div class="col-6 col-sm-4 col-lg-2 text-center"><a href=""><img class="img-fluid"
                                src="{{asset('assets/client/images/partner/partner-8.png')}}" alt="Brands"></a></div>
                    <div class="col-6 col-sm-4 col-lg-2 text-center"><a href=""><img class="img-fluid"
                                src="{{asset('assets/client/images/partner/partner-9.png')}}" alt="Brands"></a></div>
                    <div class="col-6 col-sm-4 col-lg-2 text-center"><a href=""><img class="img-fluid"
                                src="{{asset('assets/client/images/partner/partner-10.png')}}" alt="Brands"></a></div>
                    <div class="col-6 col-sm-4 col-lg-2 text-center"><a href=""><img class="img-fluid"
                                src="{{asset('assets/client/images/partner/partner-11.png')}}" alt="Brands"></a></div>
                    <div class="col-6 col-sm-4 col-lg-2 text-center"><a href=""><img class="img-fluid"
                                src="{{asset('assets/client/images/partner/partner-1.png')}}" alt="Brands"></a></div>
                </div>
            </div>
