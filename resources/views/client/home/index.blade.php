    ...
    <div class="owl-carousel owl-theme single-slideshow" data-autoplay="true" data-loop="true" data-autoheight="true"
        ...
        <div class="item">
            <section class="hero-wrap section shadow-md">
                ...
                <div class="hero-bg" style="background-image:url({{asset('assets/client/images/bg/image-1.jpg')}});">
                </div>

                <div class="hero-content py-2 py-lg-5">
                    <div class="container text-center">
                        <h2 class="text-16 text-white">Send & Receive Money</h2>
                        <p class="text-5 text-white mb-4">Quickly and easily send, receive and request money online with
                            Payyed.<br class="d-none d-lg-block">
        ...
        <div class="item">
            <section class="hero-wrap section shadow-md">
                <div class="hero-bg" style="background-image:url({{asset('assets/client/images/bg/image-3.jpg')}});">
                </div>
                    ...
                    <div class="row banner style-2 justify-content-center">
                        <div class="col-12 col-sm-6 mb-4 text-center">
                            <div class="item rounded shadow d-inline-block"> <a href="#">
                                    ...
                                    <img class="img-fluid" src="{{asset('assets/client/images/anyone-freelancer.jpg')}}"
                                        alt="banner">
                                </a> </div>
                        </div>
                        <div class="col-12 col-sm-6 mb-4 text-center">
                            <div class="item rounded shadow d-inline-block"> <a href="#">
                                    ...
                                    <div class="banner-mask"></div>
                                    <img class="img-fluid"
                                        src="{{asset('assets/client/images/anyone-online-shopping.jpg')}}" alt="banner">
                                </a> </div>
                        </div>
                        <div class="col-12 col-sm-6 mb-4 mb-sm-0 text-center">
                            <div class="item rounded shadow d-inline-block"> <a href="#">
                                    ...
                                    <div class="banner-mask"></div>
                                    <img class="img-fluid"
                                        src="{{asset('assets/client/images/anyone-online-sellers.jpg')}}" alt="banner">
                                </a> </div>
                        </div>
                        <div class="col-12 col-sm-6 text-center">
                            <div class="item rounded shadow d-inline-block"> <a href="#">
                                    ...
                                    <div class="banner-mask"></div>
                                    <img class="img-fluid"
                                        src="{{asset('assets/client/images/anyone-affiliate-marketing.jpg')}}"
                                        alt="banner">
                                </a> </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card bg-dark-3 shadow-sm border-0"> <img class="card-img opacity-8"
                            src="{{asset('assets/client/images/how-work.jpg')}}" alt="banner">
