  ...
  ============================================= -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-7 col-xl-6 text-center text-lg-left">
                        ...
                        <p class="text-5 text-white line-height-4 mb-4">Signing up to a Payyed account is FREE of
                            charge.
                            Create your account today and start!</p>
                        <a href="#" class="btn btn-primary my-2 mr-2">Open a Free Account</a> <a
                            class="btn btn-link text-light video-btn my-2" href="#"
                            data-src="https://www.youtube.com/embed/7e90gBu4pas" data-toggle="modal"
                            data-target="#videoModal"><span class="mr-2"><i class="fas fa-play-circle"></i></span>See
                            How it Works</a>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 mb-5">
                    <div class="bg-white shadow-sm rounded p-4 text-center">
                        <div class="featured-box style-4 py-2">
                            <div class="featured-box-icon text-light border rounded-circle shadow-none"> <i
                                    class="fas fa-download"></i> </div>
                            <h3 class="text-body text-7 mb-3">Withdrawal Funds</h3>
                            <p class="text-4 line-height-4">You can easily withdraw funds to your local bank account in
                                local currency at excellent rates.</p>
                            <div class="text-primary text-10 pt-3 pb-4 mb-2">up to 1.5%</div>
                            <a href="#" class="text-muted btn-link text-4">Learn more<i
                ...
                <div class="col-md-6 mb-5">
                    <div class="bg-white shadow-sm rounded p-4 text-center">
                        <div class="featured-box style-4 py-2">
                            ...
                            <p class="text-4 line-height-4">With a wide variety of options for deposit your account.
                                There is always an option that is right for you.</p>
                ...
                <div class="col-md-6 mb-5">
                    <div class="bg-white shadow-sm rounded p-4 text-center">
                        <div class="featured-box style-4 py-2">
                            ...
                            <p class="text-4 line-height-4">We always give you the mid-market rate, which is the fairest
                                exchange rate. </p>
                ...
                <div class="col-md-6 mb-5">
                    <div class="bg-white shadow-sm rounded p-4 text-center">
                        <div class="featured-box style-4 py-2">
                            ...
                            <p class="text-4 line-height-4">Keep using your Payyed Account and you will never be charged
                                an administrative fee!</p>
                            <div class="text-primary text-10 pt-3 pb-4 mb-2">Free</div>
                            <a href="#" class="text-muted btn-link text-4">Learn more<i
                                    class="fas fa-chevron-right text-2 ml-2"></i></a>
                        </div>
    ...
    <section class="section bg-primary">
        <div class="container text-center">
            ...
            <p class="text-5 text-white mb-4">Quickly and easily send, receive and request money. Over 180 countries and
                80 currencies supported.</p>
            <a href="#" class="btn btn-light">Open a Free Account</a>
        </div>
    </section>
    <!-- Banner end -->
    ...
    <section class="section py-5">
        <div class="container">
            <div class="justify-content-center text-center">
                ...
                <p class="text-4 mb-4">Download our app for the fastest, most convenient way to send &amp; get Payment.
                </p>
                <a class="d-inline-flex mx-3" href=""><img alt=""
                        src="{{asset('assets/client/images/app-store.png')}}"></a> <a class="d-inline-flex mx-3"
                    href=""><img alt="" src="{{asset('assets/client/images/google-play-store.png')}}"></a>
            </div>
        </div>
    </section>
    <!-- Mobile App end -->
